...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    instituteSubtitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide header for the RIT website';
    displayName: 'Header';
    pluralName: 'headers';
    singularName: 'header';
  };
...
export interface ApiMainNavbarMainNavbar extends Struct.SingleTypeSchema {
  collectionName: 'main_navbars';
  info: {
    description: 'Main navigation bar with dropdown menus';
...
export interface ApiNavItemNavItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hierarchical navigation item \u2014 3 tiers via self-referencing parent';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Generic page content type';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
